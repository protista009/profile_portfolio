...
const exampleText = ['Pooja', 'Btech second year student', 'from Electrical Department', ];
...
document.addEventListener("DOMContentLoaded",function(){
    const exampleText = [' C & C++', 'basic node.js', 'basic React','basic javascript' ];
    const exampleTyping = new AutoTyping('#example', exampleText, {
        typeSpeed: 50,
        deleteSpeed: 50,
        waitBeforeDelete: 2000,
        waitBetweenWords: 500,
